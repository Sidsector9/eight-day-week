...
class Article_Zip_Factory {
	...
	public function get_xml_file( $article ) {
		include_once EDW_INC . 'lib/class-article-file.php';
		...
		return new \Article_File( $file_contents, apply_filters( __NAMESPACE__ . '\xml_full_filename', $file_name, $article ) );
	}
	...
	public function get_xml( $article ) {
		include_once EDW_INC . 'lib/class-article-xml.php';
	...
	public function output_zip() {
		include_once EDW_INC . 'lib/class-articles-zip.php';
...
function get_attachment_file( $attachment ) {
	...
	return new \Article_File( get_attached_file( $attachment->ID ) );
}
