...
function register_taxonomy() {
	...
	$args = array(
		...
		'public'             => false,
		// Don't show under posts menu as of WP 4.4, setting show_ui to false
		// yields "You are not allowed to manage these items.".
		'show_ui'            => true,
		'show_in_menu'       => false,
 ...
 *
 * @param string $incoming The incoming article status.
 * @param obj    $item The article object.
 *
...
function bulk_edit_article_statuses_ajax() {
	...
	$article_ids = isset( $_POST['checked_articles'] ) ? $_POST['checked_articles'] : false;
