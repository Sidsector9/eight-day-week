...
class Section_Factory {
	 ...
	 *
	 * @param obj $section The section.
	 * @param obj $print_issue The print issue.
	 */
	 ...
	 * @throws \Exception When an invalid print issue is specified.
	 */
...
class Section {
	 ...
	 *
	 * @throws \Exception When an invalid post ID is supplied.
	 */
	 ...
	 * Updates the section
	 *
	 * @param array $args The arguments with which to update.
	 *
	 * @uses wp_update_post
	 *
	 ...
	 * @throws \Exception When failed to update a section.
	 */
	public function update( $args ) {
		...
		/* translators: %s is replaced with the section ID */
	 ...
	 * @param string $title The new title.
	 *
	 * @throws \Exception When an invalid title is supplied.
	 */
